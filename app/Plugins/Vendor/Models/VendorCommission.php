...
class VendorCommission extends BaseModel
{
    ...
    /**
     * Get the vendor that owns the commission rate.
     */
     ...
     */
    public function scopeApplicable($query, $vendorId, $hotelId, $roomTypeId = null, $boardTypeId = null)
    {
        ...
        return $query->where(function ($q) use ($hotelId, $roomTypeId, $boardTypeId) {
            ...
            // Default vendor rate (applies to all hotels)
