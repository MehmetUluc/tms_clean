...
class FinancialSummaryFixed extends Page implements HasTable
{
    ...
    // Use the partner namespace to locate the view
    protected static string $view = 'partner::filament.pages.financial-summary-fixed';
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('amount')
                    ->label('Amount')
                    ->money(fn () => config('partner.default_currency', 'TRY'))
                    ->sortable(),
